...
% TODO this paragraph is a bit awkward



\paragraph{Latent Variable Models}

% TODO make link with previous paragraph smoother
...
% TODO maybe move this figure a bit further down?
\begin{figure}[t]
\centering
\begin{tikzpicture}[
    >=Latex,
...
% TODO is the sequence logical, where we first discuss the consequences, and then how artefact and system-level relate to reflective/formative? 
...
% TODO the role of emp validation _in this thesis_
