...
Hence, artefact-level evaluation requires a different measurement specification. When the target is the quality of a specific answer or the attractiveness of a specific deal, the relevant criteria are not interchangeable indicators of a hidden ability. Rather, they define the dimensions along which the artefact is evaluated. Artefact-level diagnostic evaluation is therefore best understood formatively: the overall construct is composed of theoretically relevant dimensions, and its meaning is determined by the dimensions through which it is measured. 
...
The role of empirical validation in this thesis is to evaluate the consequences of construct representation. The previous subsection identified construct underrepresentation and construct underspecification as central validity risks for formative artefact-level measurement. If these risks matter empirically, then more explicitly specified representations of the target construct should show stronger relationships with relevant external criteria than holistic or weakly specified alternatives. Stronger validity evidence is obtained when theoretically specified criterion measurements explain or predict the external criterion more clearly, more strongly, or more consistently than less specified scores.
...
This logic implies two empirical tasks. First, the analyses compare whether increasingly explicit construct representations produce stronger external validity evidence than holistic or weakly specified alternatives. Second, because stronger external validity evidence does not by itself guarantee diagnostic interpretability, the analyses examine whether the resulting criterion scores exhibit the measurement properties needed for formative interpretation, including empirical separability, usable score distributions, and robustness to construct-irrelevant text features. 
The next section operationalizes this framework in two complementary validation settings: a convergent-validity setting based on human quality judgments and a predictive-validity setting based on behavioral outcomes.
